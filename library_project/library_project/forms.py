...
class SearchForm(forms.Form):
    ...
    lower_publish_year = forms.IntegerField(label="Minimum Year",initial=-9999, min_value=-9999, required=False)
    upper_publish_year = forms.IntegerField(label="Maximum Year",initial=datetime.date.today().year, min_value=-9999, required=False)
